...
#######################################################################
# Packages
install_if_missing archivemount atool avfs direnv nodejs npm ranger ripgrep \
    rustup tldr tree universal-ctags update-notifier-common xclip xdg-utils zsh
